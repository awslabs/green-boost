# Module 6: Tooling
Green Boost (GB) tooling includes: PNPM, ESLint, cdk-nag, husky, lint-staged, prettier, type checking. GB projects created with gboost create are setup as a monorepo. Lear more below
