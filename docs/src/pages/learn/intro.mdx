...
## Why Green Boost?
GB was built to speed up [AWS Professional Services](https://aws.amazon.com/professional-services/) delivery of web apps to customers. Many web apps have similar needs when it comes to setting up a repository, authentication, user management, CI/CD pipelines, etc. GB's goal is provide the undifferentiated heavy lifting in these common areas. To do this, GB provides an opinionated way to build these common web app components.
