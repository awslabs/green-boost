 ...
 * @example
 * ```ts
 * console.log(generateDynamoUpdateParams({ name: "Widget 1", description: "Widget 1's Description" }));
 * `{
 *    ExpressionAttributeNames: { "#name": "name", "#description": "description" },
 *    ExpressionAttributeValues: { ":name": "Widget 1", "#description": "Widget 1's Description" },
